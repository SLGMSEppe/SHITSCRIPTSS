if game.PlaceId == 8343259840 then
	local Success, Error = pcall(function()
		...
		function JoinDiscord()  
			-- setclipboard(https://discord.gg/syrexhub")
			StarterGui:SetCore("SendNotification", {Title = Version; Text = "Thank's for choosing Seppe Ware. For support dm seppe1 !"; Icon = "rbxassetid://8426126371"; Duration = 30 })
		end
		...
		local Framework                = loadstring(game:HttpGet("https://raw.githubusercontent.com/SLGMSEppe/SHITSCRIPTSS/main/TestUI.lua", true))() -- https://raw.githubusercontent.com/SLGMSEppe/SHITSCRIPTSS/main/TestUI.lua
		local ESPFramework             = loadstring(game:HttpGet("https://raw.githubusercontent.com/SLGMSEppe/SHITSCRIPTSS/main/ESP.lua", true))()
		local Watermark                = Framework:CreateWatermark("Seppe Ware | {game} | {fps}")

		--if wlID[game.Players.LocalPlayer.UserId] then
		--Seppe Ware                  = Framework:CreateWindow(Version, Vector2.new(550, 700)) -- 492, 588
		--else
		local Seppe Ware                  = Framework:CreateWindow(Version, Vector2.new(492, 700)) -- 492, 588
		--end

		local Credits                  = Seppe Ware:CreateTab("Settings")
		-- if wlID[game.Players.LocalPlayer.UserId] then
		-- 	Prem = Seppe Ware:CreateTab("Premium")
		...
		-- 	end)
		-- end
		local General                  = Seppe Ware:CreateTab("General")
		local Extra                    = Seppe Ware:CreateTab("Extra")
		local Visuals                  = Seppe Ware:CreateTab("Visuals")
		local TeleportsSS              = Seppe Ware:CreateTab("Teleport Area")
		local TeleportsS               = Seppe Ware:CreateTab("Teleports")
		...
		for i, v in pairs(game.Players:GetPlayers()) do
			...
			elseif v.UserId == 151691292 or v.UserId == 92504899 or v.UserId == 31967243 then
				StarterGui:SetCore("SendNotification", {Title = "Seppe Ware"; Text = "Devs Alert\n"..v.Name..", Is in the server."; Icon = "rbxassetid://8426126371"; Duration = 120 })
			elseif v.UserId == 2523879845 then
				StarterGui:SetCore("SendNotification", {Title = "Seppe Ware"; Text = "Owner Alert\nRvvz, Is in the server."; Icon = "rbxassetid://8426126371"; Duration = 120 })
			end
		end
		-- #endregion
		...
		MainS:AddButton("Melee God Mode", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/NougatBitz/Femware-Leak/main/meleegod.lua", true))()
		end)
